...
data.obj{1}=tableGrid; data.obj{2}=table; data.obj{3}=iceTray;
tableCell=Grid9PtsPos2(data.obj,R_opti2room,durSync, [6 5 7],1);
...
for t=durSync(1):4:durSync(end)
    t
    demo_sorting2_hand2( data, tt,dur, t,Img,cols);
