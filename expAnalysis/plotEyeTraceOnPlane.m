...
scatter(100*planeCell.pts2D(1,:),100*planeCell.pts2D(2,:),'lineWidth',3,'MarkerEdgeColor','k');
xlabel('cm'); ylabel('cm');
...
scatter(atand(planeCell.pts2D(1,:)/eye2NinePtsDis)*60,atand(planeCell.pts2D(2,:)/eye2NinePtsDis)*60,'lineWidth',3,'MarkerEdgeColor','k');
